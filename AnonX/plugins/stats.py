...
**Toplam start veren kullanıcı sayısı:** {served_users} 
**Toplam Yasaklı Kişi Sayısı:** {blocked} 
**sᴜᴅᴏᴇʀs:** {sudoers} 
    
**TOPLAM ŞARKI SAYISI:** {total_queries} 
**TOPLAM ASİSTAN SAYISI:** {assistant}
**OTOMATİK GRUPTAN AYRILMA:** {ass}
**OTOMATİK SİLME:** {cm} DAKİKA

**SÜRE SINIRI:** {play_duration} DAKİKA
**SÜRE SINIRI:** {song} DAKİKA
**OYNATMA LİSTESİ SINIRI:** {playlist_limit}
**OYNATMA LİSTESİ OYNATMA SINIRI:** {fetch_playlist}"""
